...
export { downloadEndpoint, filenameFromDisposition } from './download';
import { downloadProjectTarget as downloadTarget } from './download';

// API endpoint configuration
const API_BASE_URL = '/projects/v1';

/** Auth remains at the application boundary; download handling stays testable. */
export function downloadProjectTarget(projectId, target, options = {}) {
  return downloadTarget(projectId, target, { ...options, fetcher: authFetch });
}
